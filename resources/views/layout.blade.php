                ...
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                   <div x-data="{show: false}" >
                     ...
                     <div x-show="show"class="py-2 absolute">
                         <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-gray-300">One<a>
                         <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-gray-300">Two<a>
                         <a href="#" class="block text-left px-3 text-sm leading-6 hover:bg-gray-300">Three<a>
                     </div>
                   </div>
