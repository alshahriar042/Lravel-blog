    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:flex lg:inline-flex items-center bg-gray-100 rounded-xl">
           <div x-data="{show: false}" @click.away="show=false">
             ...
             <button @click ="show = ! show" class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 flex lg:inline-flex">
                  {{-- Categories --}}
             ...
             <div x-show="show"class="py-2 absolute bg-gray-100 round w-32 mt-2 rounded-xl z-50 max-h-30 overflow-auto" style="display: none">
